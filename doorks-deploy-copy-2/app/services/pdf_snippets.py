...
from app.services.storage import bootstrap_data_dir
...
def extract_pdf_snippets(
    ...
    cache_path = Path(cache_dir) if cache_dir else bootstrap_data_dir(Path(__file__).resolve().parents[2], "uploads_runtime", "pdf_cache")
