...
from app.services.storage import bootstrap_data_file, repo_data_path, atomic_write_json
...
class CRMStore:
    def __init__(self, project_root: Path):
        ...
        self.customers_path = bootstrap_data_file(self.project_root, "customers_db.json")
        self.contacts_path = bootstrap_data_file(self.project_root, "contacts_db.json")
        self.customers_seed_csv = repo_data_path(self.project_root, "Customers.csv")
        self.contacts_seed_csv = repo_data_path(self.project_root, "Contacts.csv")
        self._ensure()
