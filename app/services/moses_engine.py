...
class MosesEngine:
    def __init__(self, project_root: Optional[str] = None):
        ...
        self.parts_csv = self.project_root / "data" / "parts_list.csv"
        self.documents_index_path = self.project_root / "data" / "documents_index.json"
        self.timecards_path = self.project_root / "data" / "time_cards.json"
        self.timecards_legacy_path = self.project_root / "data" / "timecards.json"
        self.timeoff_path = self.project_root / "data" / "timeoff_requests.json"
