...
class CalendarStore:
    ...
    def __post_init__(self) -> None:
        ...
        self.path = self.data_dir / "calendar_jobs.json"
        self.legacy_path = self.data_dir / "calendar" / "jobs.json"
        self.upload_root = self.data_dir / "calendar" / "uploads"
        self._ensure_schema()
    ...
    def _normalize_legacy_job(self, legacy: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "address": str(legacy.get("address") or "").strip(),
